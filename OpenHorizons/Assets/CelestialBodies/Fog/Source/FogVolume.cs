...
namespace CelestialBodies
{
    ...
    public class Fog
    {
        ...
        private float actualFogDensity;
        /// <summary>
        ...
        public void Update(float radius)
        {
            ...
            actualFogDensity = Mathf.Max(map(distance, radius, radius + DisableDistance, FogDensity, 0), 0);
        }
        ...
        {
            propertyBlock.SetVector(Properties.BoundingSphere, new Vector4(gameObject.transform.position.x, gameObject.transform.position.y, gameObject.transform.position.z, Radius));
            ...
            propertyBlock.SetFloat(Properties.FogDensity, actualFogDensity);
