...
public class VolumetricCloudsURP : ScriptableRendererFeature
{
    ...
    public class VolumetricCloudsPass : ScriptableRenderPass
    {
        ...
        private void UpdateMaterialProperties(Camera camera)
        {
            ...
            if(_transform == null)
                cloudsMaterial.SetVector(earthPosition, new Vector4(0, 0, 0, 0));
            else
            {
                cloudsMaterial.SetVector(earthPosition, new Vector4(_transform.position.x, _transform.position.y, _transform.position.z, 0));
            }
